...
export const MLB_STADIUM_LIST = Object.entries(MLB_STADIUM_MAP)
    ...
    .filter(s => s.id !== 0 /* MlbTeam.FA */);
export const MLB_DOME_LIST = MLB_STADIUM_LIST.filter(s => [14 /* MlbTeam.Tor */, 29 /* MlbTeam.Ari */, 30 /* MlbTeam.TB */, 9 /* MlbTeam.Min */, 18 /* MlbTeam.Hou */, 28 /* MlbTeam.Mia */, 13 /* MlbTeam.Tex */].includes(s.id));
//# sourceMappingURL=stadium.const.js.map